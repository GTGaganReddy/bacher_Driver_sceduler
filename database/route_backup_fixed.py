"""
Route Backup and Recovery System - Fixed Version
Provides mechanisms to backup and restore original system routes (42 routes total)
"""
...
ORIGINAL_ROUTES_BACKUP = [
    ...
    # Tuesday 2025-07-08 (8 routes) - route_id 9-16
    {"route_id": 9, "date": "2025-07-08", "route_name": "431oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 10, "date": "2025-07-08", "route_name": "432oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 11, "date": "2025-07-08", "route_name": "433oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 12, "date": "2025-07-08", "route_name": "434oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 13, "date": "2025-07-08", "route_name": "435oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 14, "date": "2025-07-08", "route_name": "436oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 15, "date": "2025-07-08", "route_name": "437oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 16, "date": "2025-07-08", "route_name": "438oS", "details": {"duration_hours": 12, "type": "regular"}},
    
    # Wednesday 2025-07-09 (8 routes) - route_id 17-24
    {"route_id": 17, "date": "2025-07-09", "route_name": "431oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 18, "date": "2025-07-09", "route_name": "432oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 19, "date": "2025-07-09", "route_name": "433oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 20, "date": "2025-07-09", "route_name": "434oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 21, "date": "2025-07-09", "route_name": "435oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 22, "date": "2025-07-09", "route_name": "436oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 23, "date": "2025-07-09", "route_name": "437oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 24, "date": "2025-07-09", "route_name": "438oS", "details": {"duration_hours": 12, "type": "regular"}},
    
    # Thursday 2025-07-10 (8 routes) - route_id 25-32
    {"route_id": 25, "date": "2025-07-10", "route_name": "431oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 26, "date": "2025-07-10", "route_name": "432oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 27, "date": "2025-07-10", "route_name": "433oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 28, "date": "2025-07-10", "route_name": "434oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 29, "date": "2025-07-10", "route_name": "435oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 30, "date": "2025-07-10", "route_name": "436oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 31, "date": "2025-07-10", "route_name": "437oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 32, "date": "2025-07-10", "route_name": "438oS", "details": {"duration_hours": 12, "type": "regular"}},
    
    # Friday 2025-07-11 (8 routes) - route_id 33-40
    {"route_id": 33, "date": "2025-07-11", "route_name": "431oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 34, "date": "2025-07-11", "route_name": "432oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 35, "date": "2025-07-11", "route_name": "433oS", "details": {"duration_hours": 11, "type": "regular"}},
    {"route_id": 36, "date": "2025-07-11", "route_name": "434oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 37, "date": "2025-07-11", "route_name": "435oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 38, "date": "2025-07-11", "route_name": "436oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 39, "date": "2025-07-11", "route_name": "437oS", "details": {"duration_hours": 12, "type": "regular"}},
    {"route_id": 40, "date": "2025-07-11", "route_name": "438oS", "details": {"duration_hours": 12, "type": "regular"}},
    
    # Saturday 2025-07-12 (2 routes) - route_id 41-42
    {"route_id": 41, "date": "2025-07-12", "route_name": "451SA", "details": {"duration_hours": 10, "type": "regular"}},
    {"route_id": 42, "date": "2025-07-12", "route_name": "452SA", "details": {"duration_hours": 10, "type": "special", "assigned_driver": "Klagenfurt - Samstagsfahrer"}}
]
...
class RouteBackupManager:
    ...
    async def check_missing_routes(self) -> List[str]:
        ...
        try:
            async with self.db_manager.get_connection() as conn:
                ...
                # Create set of existing route keys
                existing_keys = set()
                for route in existing_routes:
                    route_key = f"{route['route_name']} on {route['date']}"
                    existing_keys.add(route_key)
                
                logger.info(f"Current system has {len(existing_routes)} original routes (route_id 1-42)")
                
                # Check which original routes are missing
                missing_routes = []
                for route_data in ORIGINAL_ROUTES_BACKUP:
                ...
                logger.info(f"Found {len(missing_routes)} missing original routes")
    ...
    async def restore_default_fixed_assignments(self) -> int:
        """Restore the 36 default fixed assignments to initial state"""
        try:
            async with self.db_manager.get_connection() as conn:
                ...
                # Insert default fixed assignments
                restored_count = 0
